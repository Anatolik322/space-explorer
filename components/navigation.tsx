...
export default function Navigation() {
  ...
  const routes = [
    { name: "Home", path: "/", icon: <Rocket className="h-5 w-5 mr-2" /> },
    { name: "Near-Earth Objects", path: "/neo", icon: <Planet className="h-5 w-5 mr-2" /> },
    { name: "Mars Rovers", path: "/mars", icon: <ImageIcon className="h-5 w-5 mr-2" /> },
    { name: "Media Search", path: "/search", icon: <Search className="h-5 w-5 mr-2" /> },
    { name: "Data Visualizations", path: "/visualizations", icon: <BarChart2 className="h-5 w-5 mr-2" /> },
  ]
